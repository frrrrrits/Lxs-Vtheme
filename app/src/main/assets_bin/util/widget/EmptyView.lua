...
function EmptyView:addActions(label,icon,call)
  ...
  local buttonColor=theme.color.colorOnSurface --ColorStateList.valueOf(this.getThemeColor(R.attr.colorOnBackground))
  local actionsButton=MaterialButton(buttonContext,nil,R.attr.borderlessButtonStyle)
  actionsButton.layoutParams=LinearLayout.LayoutParams(
  0,LinearLayout.LayoutParams.WRAP_CONTENT,1
  )
  actionsButton.cornerRadius=uihelper.dp2px(5)
  actionsButton.text=label
  actionsButton.textColor=buttonColor
  -- actionsButton.iconTint=ButtonColor
